...
public class AtomHashMapEqTests
{
    ...
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal,
            ("foo", 3), ("bar", 42));
    ...
    public void SwapKeyInvokesChange()
    {
        ...
        hashMap.SwapKey("foo", i => i + 1, EqInt.Comparer);
    ...
    public void SwapKeyOptionalInvokesChange()
    {
        ...
        hashMap.SwapKey("foo", i => None, EqInt.Comparer);
    ...
    {
        var hashMap = AtomHashMap<string, int>(StringComparer.Ordinal,
            ("foo", 3), ("bar", 42), ("biz", 7));
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state        = default!;
        hashMap.Change += v => state = v;
    ...
    public void AddInvokesChange()
    {
        ...
        hashMap.Add("biz", 7, EqInt.Comparer);
    ...
    public void TryAddInvokesChange()
    {
        ...
        hashMap.TryAdd("biz", 7, EqInt.Comparer);

        Assert.Equal(initialValue, state.From);
        Assert.Equal(hashMap.ToHashMap(), state.To);
        Assert.Equal(HashMap(("biz", Change<int>.Added(7))), state.Changes);
    }
    ...
    public void AddOrUpdateInvokesChange()
    {
        ...
        hashMap.AddOrUpdate("biz", 7, EqInt.Comparer);
    ...
    public void AddRangeInvokesChange()
    {
        ...
        hashMap.AddRange(Seq(("biz", 7), ("baz", 9)), EqInt.Comparer);
    ...
    public void TryAddRangeInvokesChange()
    {
        ...
        hashMap.TryAddRange(Seq(("biz", 7), ("baz", 9)), EqInt.Comparer);
    ...
    public void AddOrUpdateRangeInvokesChange()
    {
        ...
        hashMap.AddOrUpdateRange(Seq(("biz", 7), ("baz", 9)), EqInt.Comparer);
    ...
    public void FindOrAddInvokesChange()
    {
        ...
        hashMap.FindOrAdd("biz", () => 7, EqInt.Comparer);
    ...
    public void FindOrMaybeAddInvokesChange()
    {
        ...
        hashMap.FindOrMaybeAdd("biz", () => Some(7), EqInt.Comparer);
    ...
    public void SetItemsInvokesChange()
    {
        ...
        hashMap.SetItems(Seq(("foo", 80), ("bar", 17)), EqInt.Comparer);
    ...
    public void TrySetItemsInvokesChange()
    {
        ...
        hashMap.TrySetItems(Seq(("foo", 80), ("bar", 17), ("biz", 33)), EqInt.Comparer);
    ...
    public void SetItemFuncInvokesChange()
    {
        ...
        hashMap.SetItem("foo", i => i * 2, EqInt.Comparer);
    ...
    public void TrySetItemInvokesChange()
    {
        ...
        hashMap.TrySetItem("foo", 80, EqInt.Comparer);
    ...
    public void TrySetItemFuncInvokesChange()
    {
        ...
        hashMap.TrySetItem("foo", i => i * 2, EqInt.Comparer);
    ...
    public void AppendInvokesChange()
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal,
            ("foo", 3), ("bar", 42));
        var                                toAppend = HashMap<string, int>(("foo", 7), ("biz", 7), ("baz", 9));
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state = default!;
        hashMap.Change += v => state = v;

        hashMap.Append(toAppend, EqInt.Comparer);
    ...
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal, ("foo", 3), ("bar", 42));
        var toAppend = AtomHashMap(StringComparer.Ordinal, ("foo", 7), ("biz", 7), ("baz", 9));
        var initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state = default!;
        hashMap.Change += v => state = v;
    ...
    public void SubtractInvokesChange()
    {
        ...
        var toSubtract = HashMap<string, int>(
            ("foo", 7), ("biz", 7), ("baz", 9));
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state        = default!;
        hashMap.Change += v => state = v;
    ...
    public void SubtractAtomInvokesChange()
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal,
            ("foo", 3), ("bar", 42), ("biz", 7), ("baz", 9));
        var toSubtract = AtomHashMap(StringComparer.Ordinal,
            ("foo", 7), ("biz", 7), ("baz", 9));
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state        = default!;
        hashMap.Change += v => state = v;
    ...
    public void IntersectAtomInvokesChange()
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal,
            ("foo", 3), ("bar", 42), ("biz", 7), ("baz", 9));
        var toIntersect = AtomHashMap(StringComparer.Ordinal,
            ("foo", 7), ("biz", 7), ("baz", 9), ("bin", 0));
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state        = default!;
        hashMap.Change += v => state = v;
    ...
    public void SymmetricExceptInvokesChange()
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal,
            ("foo", 3), ("bar", 42));
        var toExcept = AtomHashMap(StringComparer.Ordinal,
            ("foo", 3), ("biz", 7), ("baz", 9));
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state        = default!;
        hashMap.Change += v => state = v;
    ...
    {
        var hashMap = AtomHashMap(StringComparer.Ordinal,("foo", 3), ("bar", 42));
        var toUnion = AtomHashMap(StringComparer.Ordinal,("foo", 7), ("biz", 7), ("baz", 9));
            
        var                                initialValue = hashMap.ToHashMap();
        HashMapPatch<string, int> state        = default!;
        hashMap.Change += v => state = v;

        hashMap.Union(toUnion, EqInt.Comparer);
    ...
    public void Union_TakeRight_InvokesChange()
    {
        ...
        hashMap.Union(toUnion, Merge: (_, _, r) => r, EqInt.Comparer);
    ...
    public void Union_TakeLeft_InvokesChange()
    {
        ...
        hashMap.Union(toUnion, Merge: (_, l, _) => l, EqInt.Comparer);
